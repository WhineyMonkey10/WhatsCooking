...
def main(context):
    ...
    if userId == None:
        userId = databases.list_documents("6890ded500064cf8b023", "689791b100072ce22e05", queries=[Query.equal("accountDeletionVerificationCode", str(context.req.body))])['documents'][0]['$id']
